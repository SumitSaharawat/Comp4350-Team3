...
const SearchBar = ({
    ...
    return (
        <label
            className={`relative bg-customSecondDark/60 input input-bordered flex items-center gap-2 px-2 h-11 rounded-xl 
        ...
        >
            ...
            {inputText ? (
                <button
                    onClick={clearInput}
                    className="absolute right-2 text-gray-500 hover:text-gray-400 transition-colors"
                >
