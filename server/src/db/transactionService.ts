...
export const addTransaction = async (userId: string, name: string, date: string, amount: number, currency: string, tag: ITag) => {
    try {
        console.log("Received transaction data:", { userId, name, date, amount, currency, tag });
...
export const editTransaction = async (id: string, name?: string, date?: string, amount?: number, currency?: string, tag?: ITag): Promise<ITransaction | null> => {
    try {
